...
# Constants
SLEEP_BETWEEN_GROQ = int(os.getenv("SLEEP_BETWEEN_GROQ", 2000))
FETCH_INTERVAL = int(os.getenv("FETCH_INTERVAL", 10000))
NO_UPDATE_NOTIFY_GAP = int(os.getenv("NO_UPDATE_NOTIFY_GAP", 5000))
